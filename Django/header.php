			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +254728746107</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> officialndula@gmail.com</a></li>
						...
						<li><?php
                            ...
                            if(isset($_SESSION["uid"])){
                               ...
                               <div class="dropdownn">
                                ...
                                echo '
                                <div class="dropdownn">
                                  <a href="myaccount.php" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> My Account</a>
                                  <div class="dropdownn-content">
...
<div class="modal fade" id="Modal_news" role="dialog">
                        <div class="modal-dialog">
