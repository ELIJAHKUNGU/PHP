...
//SELECT movies.title, movies.cover, sales.quantity, sales.total, sales.date_sold FROM movies JOIN sales ON movies.movie_id =sales.sale_id
?>
<!doctype html>
<html lang="en">
<head>
